var width = 500,
    ...
    var svg = d3.select("svg").append("g").attr("id", "chart")
      .attr("width", width + margin.right + margin.left)
      .attr("height", height + margin.left + margin.right)
      .append("g").attr("class", "SpiralClass")
  ...
  //	console.log(val);
    ...
    svg.selectAll("rect")
      ...
      .attr("x", function(d,i){
        ...
        d.x = posOnLine.x+220; // x postion on the spiral
        d.y = posOnLine.y+300; // y position on the spiral
